				...
				<div class="col-8 rounded" style="height: 85vh;">
					<div style="box-shadow: 0 0 50px rgba(255, 255, 255, 0.4);">
						<iframe class="rounded" width="100%" height="400"
							src="https://www.youtube.com/embed/dQw4w9WgXcQ?si=WrUZZkFhvoTFgJqR&autoplay=1&mute=1"
							title="Rickroll" frameborder="0"
							allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
							referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
					</div>
					<div>
						<h3 class="text-white mt-2 mb-3">Rick Astley - Never Gonna
							Give You Up (Official Music Video)</h3>
